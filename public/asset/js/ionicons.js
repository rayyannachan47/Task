...
*/
    ...
    function matches(el, selector) {
      return (
        selector === ":root" || selector === "html" || el.matches(selector)
      );
    }
    ...
    function loadDocumentLinks(doc, globalScopes) {
      var promises = [];
      var linkElms = doc.querySelectorAll(
    ...
    var scriptElm =
      currentScript ||
      Array.from(doc.querySelectorAll("script")).find(function (s) {
        return (
          regex.test(s.src) ||
    ...
    var resourcesUrl = scriptElm
      ...
      : "";
    // var start = function () {
    //   var url = new URL("./public/ionicons_files/p-d8be3baa.system.js", resourcesUrl);
