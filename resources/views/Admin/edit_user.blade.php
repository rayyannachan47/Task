...
<div id="sidebar_paddings">
    <div class="container-fluid">
        <div class="formHolder">
            <div class="d_flex">
                <label class="bold_font_DS font_25 margin_bottom_10">Edit User</label>
            </div>
            <div class="clear"></div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" data-parsley-trigger="blur" class="form-control simplebox" id="username" name="username" data-parsley-trigger="blur" required="" data-parsley-errors-container=".errorsusername" data-parsley-pattern="^[a-zA-Z]+(?:\s[a-zA-Z]+)*$" data-parsley-required-message="Name is required." placeholder="Edit Name" value="{{ $edituserdetails->name }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control simplebox" id="email" name="email" autocomplete="nope" data-parsley-type="email" data-parsley-trigger="blur" required="" data-parsley-required-message="Email is required." data-parsley-errors-container=".errorsemail" placeholder="Edit Email" value="{{ $edituserdetails->email }}" disabled>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" data-parsley-trigger="blur" class="form-control simplebox" id="dob" name="dob" data-parsley-trigger="blur" required="" data-parsley-errors-container=".errorsdob" value="{{ date('Y-m-d', strtotime($edituserdetails->dob)) }}" data-parsley-required-message="Date of birth is required." max="<?php echo date('Y-m-d'); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea id="address" class="form-control simplebox" name="address" rows="4" cols="50" data-parsley-pattern="^[a-zA-Z0-9\s,.-]+$" data-parsley-pattern-message="Address should not contain special characters." required data-parsley-required-message="Address is required." data-parsley-errors-container=".errorsaddress">{{ $edituserdetails->address }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" data-parsley-trigger="blur" class="form-control simplebox" id="contact" name="contact" data-parsley-trigger="blur" required="" data-parsley-errors-container=".errorscontact" data-parsley-required-message="Contact is required." data-parsley-pattern="^\d{10}$" placeholder="Edit Contact" value="{{ $edituserdetails->contact }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="photo" class="text_lable">Photo</label>
                            <input type="file" data-parsley-trigger="blur" class="form-control simplebox" id="photo" name="photo" data-parsley-trigger="blur" accept=".png,.jpg,.jpeg" onchange="validateFile(this)">
                            <span class="fileerror text-danger"></span>
                            <div id="imagePreview" style="margin-top: 10px;">
                                <img id="previewImg" src="{{$imageUrl}}" alt="Image Preview" style="width:100px; height: 100px;">
                            </div>
                        </div>
                    </div>
...
<script>
     function submit_form() {
        ...
        if (isValid) {
            ...
            $.ajax({
                url: base_url + '/Admin/edit_user_code',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
